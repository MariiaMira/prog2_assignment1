public class Main {
    public static void main(String[] args) {
        ...
        Item book1 = new Book("A guide to modern jazz", "Unknown author", 100.0, false);
        Item book2 = new Book("Beethoven: a biography", "Holmqvist", 400.0, false);
        Item book2bound = new Book("Beethoven: a biography", "Holmqvist", 400.0, true);
